...
def health():
    try:
        ...
        return jsonify({"status": status, "last_bar_timestamp": last_ts, "seconds_since_last_data": round(seconds_since, 1) if seconds_since else None, "total_bars": total_bars, "symbols_count": symbols_count})
